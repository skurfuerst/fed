 ...
 * 
 * examples of usage :
 * $myPacker = new Tx_Fed_Utility_JavascriptPacker($script, 62, true, false);
 * $packed = $myPacker->pack();
 * 
 * or
 * 
 * $myPacker = new Tx_Fed_Utility_JavascriptPacker($script, 'Normal', true, false);
 * $packed = $myPacker->pack();
 * 
 * or (default values)
 * 
 * $myPacker = new Tx_Fed_Utility_JavascriptPacker($script);
 * $packed = $myPacker->pack();
 * 
 * 
...
class Tx_Fed_Utility_JavascriptPacker {
	// constants
	const IGNORE = '$1';
