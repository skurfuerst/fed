...
class Tx_Fed_ViewHelpers_Fce_Field_UserFuncViewHelper extends Tx_Fed_ViewHelpers_Fce_FieldViewHelper {
	...
	public function initializeArguments() {
		...
		$this->registerArgument('userFunc', 'string', 'Classname->function notation of UserFunc to be called, example "Tx_Fed_Configuration_Wizard_FlexFormCodeEditor->renderField"', TRUE);
