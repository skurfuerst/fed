...
dk.wildside.display.Widget.prototype = new dk.wildside.display.DisplayObject();



// DISPLAY MANIPULATION METHODS
dk.wildside.display.Widget.prototype.enableControls = function() {
...
dk.wildside.display.Widget.prototype.disableControls = function() {
...
dk.wildside.display.Widget.prototype.displayErrors = function(errors) {
...
dk.wildside.display.Widget.prototype.displayMessages = function(messages) {
...
dk.wildside.display.Widget.prototype.setValue = function(value) {
	// default action is to do nothing - custom Widgets masquerading as Fields override this method
	this.value = value;
};

dk.wildside.display.Widget.prototype.getValue = function() {
	// default action is to return undefined - custom Widgets masquerading as Fields override this method
	return this.value;
};

dk.wildside.display.Widget.prototype.setName = function(newName) {
	this.name = newName;
};

dk.wildside.display.Widget.prototype.getName = function() {
	return this.name;
};

dk.wildside.display.Widget.prototype.setValues = function(object) {
...
dk.wildside.display.Widget.prototype.getValues = function() {
	var values = {};
	var widget = this;
...
dk.wildside.display.Widget.prototype.markDirty = function() {
	this.dirty = true;
	this.dispatchEvent(dk.wildside.event.WidgetEvent.DIRTY);
};

dk.wildside.display.Widget.prototype.markClean = function() {
	this.dispatchEvent(dk.wildside.event.WidgetEvent.CLEAN);
	this.dirty = false;
};

dk.wildside.display.Widget.prototype.rollback = function() {
	this.children.each(function(field) { field.rollback(); });
};

dk.wildside.display.Widget.prototype.remove = function() {
...
dk.wildside.display.Widget.prototype.update = function() {
...
dk.wildside.display.Widget.prototype.create = function() {
...
dk.wildside.display.Widget.prototype.sync = function() {
	if (this.dirty == false) {
...
dk.wildside.display.Widget.prototype.refresh = function() {

};

dk.wildside.display.Widget.prototype.dispatchRequest = function(request, parameterWrap) {
...
dk.wildside.display.Widget.prototype.onError = function(event) {
	var errors = this.errors;
	this.displayErrors(errors);
};

dk.wildside.display.Widget.prototype.onDirtyField = function(event) {
	this.dispatchEvent(dk.wildside.event.WidgetEvent.DIRTY);
};

dk.wildside.display.Widget.prototype.onCleanField = function(event) {
	//this.dispatchEvent(this.events.DIRTY);
};

dk.wildside.display.Widget.prototype.onDirty = function(event) {
	this.dirty = true;
...
dk.wildside.display.Widget.prototype.onClean = function(event) {
	this.dirty = false;
};

dk.wildside.display.Widget.prototype.onMessage = function(event) {
